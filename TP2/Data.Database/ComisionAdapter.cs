    ...
    public class ComisionAdapter:Adapter
    {
        ...
        public List<Comision> GetSome(int IDPlan)
        {
            ...
            try
            {
                ...
                SqlCommand cmdComisiones = new SqlCommand("SELECT C.*,P.desc_plan, E.* FROM comisiones C LEFT JOIN planes P ON P.id_plan = C.id_plan LEFT JOIN especialidades E ON E.id_especialidad = P.id_especialidad WHERE C.id_plan = @id_plan", sqlConn);
